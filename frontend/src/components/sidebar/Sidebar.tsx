...
export const Sidebar: React.FC = () => {
  return (
    <aside className="fixed left-0 top-0 z-40 hidden h-screen w-72 border-r border-sky-100/20 bg-[linear-gradient(180deg,#07111f_0%,#0b1730_38%,#0d1b36_100%)] text-white shadow-[0_20px_60px_-24px_rgba(2,8,23,0.75)] lg:block">
      <div className="flex h-full flex-col">
        <div className="border-b border-white/10 px-5 py-5">
          <div className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-sky-400 to-primary-600 shadow-lg shadow-primary-700/30">
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    cn(
                      ...
                      isActive
                        ? "bg-gradient-to-r from-primary-500/20 to-primary-600/20 text-white shadow-[inset_0_0_0_1px_rgba(56,189,248,0.35)]"
