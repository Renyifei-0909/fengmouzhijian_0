...
const QuickEntry: React.FC<{ to: string; icon: React.ReactNode; label: string }> = ({ to, icon, label }) => {
  ...
  return (
    <button
      onClick={() => navigate(to)}
      className="flex flex-col items-center justify-center rounded-2xl border border-sky-200 bg-white p-4 shadow-sm hover:border-primary-500 hover:bg-primary-50/50 transition"
    >
