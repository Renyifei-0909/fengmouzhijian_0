  ...
  return (
    <div className="space-y-4 page-enter">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-base font-semibold text-slate-900">数据分析</h2>
          <p className="mt-1 text-sm text-slate-500">告警、进度、设备多维数据可视化</p>
        </div>
        <button onClick={() => setNotice("分析报表已导出到报表中心（Demo）。")} className="flex items-center gap-1 text-sm font-semibold text-sky-700">
          导出报表 <ChevronRightIcon className="h-4 w-4" />
        </button>
      </div>
