        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs font-medium backdrop-blur-sm">
              <DatabaseIcon className="h-4 w-4" /> 数据看板 Demo
            </div>
            <h2 className="text-2xl font-semibold">施工监管数据驾驶舱</h2>
            <p className="mt-2 max-w-3xl text-sm leading-6 text-sky-100">
              汇聚项目、设备、告警、交付等核心指标，形成端边云协同监管的数据总览，用于辅助调度、汇报与项目验收。
            </p>
          </div>
          <button
            onClick={() => setNotice("数据驾驶舱快照已生成，并同步到报表中心演示列表。")}
          ...
          >
            <DownloadIcon className="h-4 w-4" /> 导出驾驶舱快照
          </button>
        </div>
      </div>
